  ...
  <body>
    ...
    <?php
        ...
        $verloren = array("PSV" => "2" , "Ajax" => "3" , "AZ" => "4" , "PEC Zwolle" => "7" , "Feyenoord" => "6" , "Vitesse" => "7" , "FC Utrecht" => "5" , "Heerenveen" => "8" ,  "VVV-Venlo" => "7" , "ADO Den Haag" => "9" , "Excelsior" => "11" , "Heracles" => "11" , "FC Groningen" => "10" , "Willem II" => "14" , "FC Twente" => "15" , "NAC Breda" => "14" , "Roda JC" => "15" , "Sparta Rotterdam" => "15");
          ...
          <table>
            <tr>
              <td>Positie: $positie[$PSV]</td><td>Positie: $positie[$Ajax]</td><td>Positie: $positie[$AZ]</td><td>Positie: $positie[$Feyenoord]</td><td>Positie: $positie[$FCUtrecht]</td><td>Positie: $positie[$PECZwolle]</td><td>Positie: $positie[$Vitesse]</td><td>Positie: $positie[$ADODenHaag]</td><td>Positie: $positie[$Heerenveen]</td>
            </tr>
            <tr>
...
>>>>>>> f5103521892ca4a8a560ddaed34d00d9523344af
            <tr>
...
>>>>>>> f33b3236b41f133ca2c25e8da5c1bcc407e17b91
            </tr>
            <tr>
            ...
            <tr>
            <td>Gelijk: $Gelijk[$PSV]</td><td>Gelijk: $Gelijk[$Ajax]</td><td>Gelijk: $Gelijk[$AZ]</td><td>Gelijk: $Gelijk[$Feyenoord]</td><td>Gelijk: $Gelijk[$FCUtrecht]</td><td>Gelijk: $Gelijk[$PECZwolle]</td><td>Gelijk: $Gelijk[$Vitesse]</td><td>Gelijk: $Gelijk[$ADODenHaag]</td><td>Gelijk: $Gelijk[$Heerenveen]</td>
            </tr>
            <tr>
            <td>Verloren: $verloren[$PSV]</td><td>Verloren: $verloren[$Ajax]</td><td>Verloren: $verloren[$AZ]</td><td>Verloren: $verloren[$Feyenoord]</td><td>Verloren: $verloren[$FCUtrecht]</td><td>Verloren: $verloren[$PECZwolle]</td><td>Verloren: $verloren[$Vitesse]</td><td>Verloren: $verloren[$ADODenHaag]</td><td>Verloren: $verloren[$Heerenveen]</td>
            </tr>
          </table>
          <br>
          <table>
          <tr>
            <td>Positie: $positie[$VVVVenlo]</td><td>Positie: $positie[$Excelsior]</td><td>Positie: $positie[$Heracles]</td><td>Positie: $positie[$FCGroningen]</td><td>Positie: $positie[$WillemII]</td><td>Positie: $positie[$NacBreda]</td><td>Positie: $positie[$FCTwente]</td><td>Positie: $positie[$RodaJC]</td><td>Positie: $positie[$SpartaRotterdam]</td>
          </tr>
          <tr>
            <td>Stad: $stad[$VVVVenlo]</td><td>Stad: $stad[$Excelsior]</td><td>Stad: $stad[$Heracles]</td><td>Stad: $stad[$FCGroningen]</td><td>Stad: $stad[$WillemII]</td><td>Stad: $stad[$NacBreda]</td><td>Stad: $stad[$FCTwente]</td><td>Stad: $stad[$RodaJC]</td><td>Stad: $stad[$SpartaRotterdam]</td>
          </tr>
          <tr>
            <td>Naam: $naam[$VVVVenlo]</td><td>Naam: $naam[$Excelsior]</td><td>Naam: $naam[$Heracles]</td><td>Naam: $naam[$FCGroningen]</td><td>Naam: $naam[$WillemII]</td><td>Naam: $naam[$NacBreda]</td><td>Naam: $naam[$FCTwente]</td><td>Naam: $naam[$RodaJC]</td><td>Naam: $naam[$SpartaRotterdam]</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Gelijk: $Gelijk[$VVVVenlo]</td><td>Gelijk: $Gelijk[$Excelsior]</td><td>Gelijk: $Gelijk[$Heracles]</td><td>Gelijk: $Gelijk[$FCGroningen]</td><td>Gelijk: $Gelijk[$WillemII]</td><td>Gelijk: $Gelijk[$NacBreda]</td><td>Gelijk: $Gelijk[$FCTwente]</td><td>Gelijk: $Gelijk[$RodaJC]</td><td>Gelijk: $Gelijk[$SpartaRotterdam]</td>
          </tr>
          <tr>
          <td>Verloren: $verloren[$VVVVenlo]</td><td>Verloren: $verloren[$Excelsior]</td><td>Verloren: $verloren[$Heracles]</td><td>Verloren: $verloren[$FCGroningen]</td><td>Verloren: $verloren[$WillemII]</td><td>Verloren: $verloren[$NacBreda]</td><td>Verloren: $verloren[$FCTwente]</td><td>Verloren: $verloren[$RodaJC]</td><td>Verloren: $verloren[$SpartaRotterdam]</td>
          </tr>
          </table>
          </center>";
       ?>
