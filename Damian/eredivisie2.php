    ...
    <?php
        ...
        $verloren = array("PSV" => "2" , "Ajax" => "3" , "AZ" => "4" , "PEC Zwolle" => "7" , "Feyenoord" => "6" , "Vitesse" => "7" , "FC Utrecht" => "5" , "Heerenveen" => "8" ,  "VVV-Venlo" => "7" , "ADO Den Haag" => "9" , "Excelsior" => "11" , "Heracles" => "11" , "FC Groningen" => "10" , "Willem II" => "14" , "FC Twente" => "15" , "NAC Breda" => "14" , "Roda JC" => "15" , "Sparta Rotterdam" => "15");
          ...
          <table>
            ...
            <tr>
              <td>Stad: $stad[$PSV]</td><td>Stad: $stad[$Ajax]</td><td>Stad: $stad[$AZ]</td><td>Stad: $stad[$Feyenoord]</td><td>Stad: $stad[$FCUtrecht]</td><td>Stad: $stad[$PECZwolle]</td><td>Stad: $stad[$Vitesse]</td><td>Stad: $stad[$ADODenHaag]</td><td>Stad: $stad[$Heerenveen]</td><td>Stad: $stad[$VVVVenlo]</td><td>Stad: $stad[$Excelsior]</td><td>Stad: $stad[$Heracles]</td><td>Stad: $stad[$FCGroningen]</td><td>Stad: $stad[$WillemII]</td>
