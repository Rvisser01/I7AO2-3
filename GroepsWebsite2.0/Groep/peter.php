...
<div class="vertical-menu">
  ...
  <a href="../../Variables/peter.PHP">thisisme.php</a>
  ...
  <a href="../../Array/onzegroep.PHP">onzegroep.php</a>
    ...
    <div class="mx-auto" style="width: 288px;">
      <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="../img/peter.jpeg" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Profile</h5>
          <p class="card-text">Naam: Peter <br>Klas: I7AO2<br>Leeftijd: 20</p>
        </div>
      </div>
    </div>
