...
#button {
  ...
  <body>
    ...
    <?php
      $gebruiker = array("voornaam" =>"Sunny","achternaam" =>"Boy","geboortedatum" =>"11-11-11","adres" =>"Sunnystraat 11","postcode" =>"1111 SU","plaats" =>"Sunnycity","emial" =>"sunny@sunny.nl","password" =>"123","minderjarig" =>"Ja" );
